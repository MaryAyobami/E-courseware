...
//   const [matricno , setMatricno] = useState('')
  ...
  */}
        <TouchableOpacity className='justify-end items-end px-4'>
            <Text className='xl font-ageoheavy text-orange'
     ...
     {/* profile information */}
            ...
            <TouchableOpacity className='flex justify-end items-end mt-12 mx-4'  onPress={ () => {
                ...
                <Text className='text-center p-4 font-ageomedium border border-orange rounded-full w-[30%] text-orange'>LOGOUT</Text>
              </TouchableOpacity>
