...
//            <Text className='text-[16px] font-ageonormal text-main'>{props.item} LEVEL</Text>
...
const LecturersAR = ({navigation,route}) => {
    ...
    const sortResources = (level)=>{
        ...
        // setShow(true)
        console.log(levelResources.current)
        // return(
        //     <DisplayResources resources={levelResources.current}/>
        // ) 
   } 
    ...
    <View>
        ...
        <View className='h-full  bg-main rounded-b-full w-screen'>
            ...
            <FlatList
                        ...
                        renderItem = {({item})=>
                        <>
                          <Displaylevel item={item} pressed={()=>sortResources(item)} show={true}/>
                              {/* {
                              showResorces && item ?
                              <DisplayResources resources={levelResources.current}/>
                              :
