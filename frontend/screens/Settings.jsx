...
const Settings = ({navigation}) => {
  ...
  return (
    <View className='bg-bgcolor h-screen '>
      ...
      {
        on?
        <Text className='font-ageoheavy text-main text-[16px]'> ON</Text>
        :
        <Text className='font-ageoheavy text-main text-[16px]'> OFF</Text>
      }
        ...
        <Text className='font-ageonormal text-[16px] text-black  w-[98%] mx-auto pt-6'>If turned on , notifications will be sent to you when new resources related to your level are uploaded.</Text>     
