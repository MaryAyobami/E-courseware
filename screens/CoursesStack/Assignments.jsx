  ...
  return (
    <View className='bg-bgcolor w-screen h-screen'>
     ...
     <Icon name="book-open-page-variant-outline" size={30} color='#ee6c4d'  style={{paddingVertical:4}} onPress={()=> navigation.goBack()} />
       <Text className='p-4 text-center text-main font-ageobold text-[27px]'>Assignment</Text>
     </View>
      {/* filter buttons */}
      <View className='w-[60%] mx-auto  flex flex-row justify-between'>
         <TouchableOpacity onPress={()=> 
          {setAll(true)
           ...
           <Text className= { all? ' text-bgcolor font-ageonormal text-center text-[18px]' : 'font-ageonormal text-grey-800 text-center text-[18px]'}>All</Text>
         </TouchableOpacity>
         ...
         <TouchableOpacity  onPress={()=> 
          ...
          setAll(false)
           ...
           <Text className={ submitted? ' text-bgcolor font-ageonormal text-center text-[18px]' : 'font-ageonormal text-grey-800 text-center text-[18px]'}>Submitted</Text>
         </TouchableOpacity>
      </View>
