...
//       <ScrollView>
//             <View className='my-4 '>
//                 <Text className='font-ageonormal text-[18px] text-pink'>Name</Text>
...
//             </View>
//             <View className='my-4 '>
//                 <Text className='font-ageonormal text-[18px] text-pink'>Matric Number</Text>
...
//             </View>
//             <View className='my-4 '>
//                 <Text className='font-ageonormal text-[18px] text-pink'>Level</Text>
...
//             <View className='my-4 '>
//                 <Text className='font-ageonormal text-[18px] text-pink'>Department</Text>
...
//             <View className='my-4 '>
//                 <Text className='font-ageonormal text-[18px] text-pink'>Email</Text>
