    ...
    <View className='w-screen h-screen bg-bgcolor '>
       ...
       <View className='w-[95%] mx-auto pt-10'>
          ...
          <TouchableOpacity className="items-center rounded-full border border-main mt-2 bg-" onPress={handleDocumentSelection}>
           <Text className="text-main  text-[18px] font-ageomedium py-4 px-12  ">Select File</Text>
          </TouchableOpacity>
            
          <Text className="text-main  text-[18px] font-ageomedium py-4 px-12  ">{filename} </Text>
          {
            filename &&
            <TouchableOpacity>
                  <Text className="text-orange1 text-center  font-ageoheavy py-1   " onPress={handlePreview}>PREVIEW FILE</Text>
            </TouchableOpacity>
